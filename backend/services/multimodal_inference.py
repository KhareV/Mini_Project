...
class MultimodalInferenceService:
    ...
    def status(self) -> Dict[str, object]:
        return {
            ...
            "status_note": "Historical research endpoint only. Its contemporaneous target was circular and its non-circular future target failed; do not use for clinical inference or FL.",
