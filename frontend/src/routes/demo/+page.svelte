...
/* Readability pass: the demo is intended to be projected during review. */
.demo-shell .kicker,
.demo-shell .run-state span,
.demo-shell .run-state small,
.demo-shell .controls,
.demo-shell .shortcuts,
.demo-shell .phase-row,
.demo-shell .metric-grid span,
.demo-shell .metric-grid footer,
.demo-shell .signal header,
.demo-shell .reasoning span,
.demo-shell .pipeline,
.demo-shell .evidence,
.demo-shell .disclaimer { font-size: 9px; }
.demo-shell .hero p { font-size: 12px; line-height: 1.8; }
.demo-shell .controls button { font-size: 9px; padding: 11px 14px; }
.demo-shell .controls select { font-size: 9px; padding: 8px; }
.demo-shell .phase-row b { font-size: 9px; }
.demo-shell .phase-row span,
.demo-shell .phase-row small { font-size: 8px; }
.demo-shell .metric-grid strong { font-size: 40px; }
.demo-shell .metric-grid .state { font-size: 30px; }
.demo-shell .decision p,
.demo-shell .events p { font-size: 12px; line-height: 1.7; }
.demo-shell .quality-bars .qrow,
.demo-shell .events div { font-size: 9px; }
.demo-shell .pipeline span,
.demo-shell .pipeline b,
.demo-shell .evidence > header span,
.demo-shell .evidence > header b,
.demo-shell .evidence > header a { font-size: 8px; }
.demo-shell .evidence-grid span,
.demo-shell .evidence-grid small { font-size: 8px; }
.demo-shell .evidence-grid strong { font-size: 30px; }
.demo-shell .disclaimer { line-height: 1.5; }
@media (max-width: 680px) {
	.demo-shell .hero p,
	.demo-shell .decision p,
	.demo-shell .events p { font-size: 11px; }
	.demo-shell .metric-grid strong { font-size: 32px; }
}
</style>
